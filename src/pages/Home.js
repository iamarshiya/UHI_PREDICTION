...
const NAV_LINKS = ["Home", "Dashboard", "Risk Report", "Forecast Future", "Climate Assistant"];
      ...
      <nav style={{
          ...
          <div style={{ display: "flex", alignItems: "center", flex: 1, justifyContent: "center", gap: 4 }}>
            {NAV_LINKS.map((link) => (
              <a key={link} href="#" style={{
                fontSize: 13, fontWeight: link === "Home" ? 700 : 500,
                padding: "7px 16px", borderRadius: 999,
                background: link === "Home" ? "#111827" : "transparent",
                color: link === "Home" ? "#fff" : "#4b5563",
                textDecoration: "none", whiteSpace: "nowrap",
                transition: "all 0.2s"
              }}
              onMouseEnter={e => { if (link !== "Home") { e.target.style.background = "#f3f4f6"; e.target.style.color = "#111827"; }}}
              onMouseLeave={e => { if (link !== "Home") { e.target.style.background = "transparent"; e.target.style.color = "#4b5563"; }}}
              >{link}</a>
            ))}
          </div>
        </div>
        ...
        <div style={{ borderTop: "1px solid #f3f4f6", background: "#f0fdf4" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto", padding: "8px 32px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <button style={{ display: "flex", alignItems: "center", gap: 6, border: "1.5px solid #22c55e", color: "#15803d", background: "transparent", fontSize: 12, fontWeight: 600, padding: "6px 16px", borderRadius: 999, cursor: "pointer", whiteSpace: "nowrap", marginLeft: 16 }}>
